...
- Added immutable decisions, idempotent observations, active/shadow learning modes, per-action priors, stable action-set fingerprints, and SQLite schema \(1 \rightarrow 2\) migration.
